...
- Navigate to `NodeJsChatBot` folder
- Select `NodeJsChatBot.bot` file
...
msbot clone services --name "NodeJsChatBot" --code-dir "." --location <azure region like eastus, westus, westus2 etc.> --sdkLanguage "Node" --folder deploymentScripts/msbotClone --verbose
```
